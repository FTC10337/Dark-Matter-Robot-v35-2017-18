...
public class Auto_Blue_L_3G extends Auto_Master {
    ...
    public void driveToBox() throws InterruptedException {
        ...
        if (iAmBlue()) {
            auto.encoderDrive(AutoHelper.DRIVE_SPEED, 5.0, 0.5, true, 0);
        } else {
            auto.encoderDrive(AutoHelper.DRIVE_SPEED, 5.0, 0.5, true, 180);
        }
        ...
        // drive back
        if (iAmBlue()) {
            auto.encoderDrive(AutoHelper.DRIVE_SPEED, -5.0, 3.0, true, 0);
        } else {
            auto.encoderDrive(AutoHelper.DRIVE_SPEED, -5.0, 3.0, true, 180);
        }
    ...
    public void driveToPile() throws InterruptedException {
        ...
        auto.encoderDrive(AutoHelper.DRIVE_SPEED, iAmBlue()? 30 + angleAdjust: 30 - angleAdjust, 3.0, true, iAmBlue()? 220 + angleAdjust: 320 - angleAdjust);
    ...
    public void loadFirstGlyph() throws InterruptedException {
        ...
        if (robot.intake.distLeft() < 16.0 || robot.intake.distRight() < 16.0) {
            ...
            auto.encoderDrive(AutoHelper.DRIVE_SPEED, -7.0, 3.0, true, iAmBlue()? 220 + angleAdjust : 320 - angleAdjust);
    ...
    public void returnToBox() throws InterruptedException {
        ...
        auto.encoderDrive(AutoHelper.DRIVE_SPEED, iAmBlue()? -inches + -30 + angleAdjust: -inches + -30 + -angleAdjust , 5, true, iAmBlue()? 220 + angleAdjust : 320 - angleAdjust);
    ...
    public void placeExtraGlyphs() throws InterruptedException {
        ...
        if (auto.glyphsCollected > 0) {
            ...
            if (vuMark == RelicRecoveryVuMark.RIGHT){
                // turn to place extra glyphs
                auto.gyroTurn(AutoHelper.DRIVE_SPEED, iAmBlue()? -40: 220, AutoHelper.P_TURN_COEFF_180);
            ...
            if (vuMark == RelicRecoveryVuMark.LEFT){
                // turn to place extra glyphs
                auto.gyroTurn(AutoHelper.DRIVE_SPEED, iAmBlue()? -40: 140, AutoHelper.P_TURN_COEFF_180);
    ...
    public void park() throws InterruptedException {
        if (auto.glyphsCollected > 0) {
            robot.lift.setLiftTop();
            auto.encoderDrive(AutoHelper.DRIVE_SPEED, -2.0, 3.0, true, iAmBlue()? -31: 211);
